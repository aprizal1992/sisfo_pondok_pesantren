...
<script>
    ...
    $(".accept").click(function() {
        ...
        swal({
            ...
            text: "Siswa ini akan diterima",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        }).then((willDelete) => {
            if (willDelete) {
                window.location = "<?= base_url("Pendaftaran/accept/") ?>" + id;
            }
        });
    });
    $(".reject").click(function() {
        ...
        swal({
            ...
            if (willDelete) {
                window.location = "<?= base_url("Pendaftaran/reject/") ?>" + id;
            }
        });
    });
    ...
    $(".addSiswa").click(function() {
        ...
        const GetSiswa = async () => {
            const getter = await axios.get(`<?= base_url() ?>axios/getSiswaDaftar/${key}`).catch(err => {
                console.log(err);
            });
